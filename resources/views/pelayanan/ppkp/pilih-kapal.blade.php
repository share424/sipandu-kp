...
<div class="xp-breadcrumbbar">
    <div class="row">
        <div class="col-md-6 col-lg-6">
            <h4 class="xp-page-title">Pilih Kapal</h4>
        </div>
        <div class="col-md-6 col-lg-6">
            <div class="xp-breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('home')}}"><i class="icon-home"></i></a></li>
                    <li class="breadcrumb-item"><a href="#">PPKP</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Pilih Kapal</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header bg-white">
                    <h5 class="card-title text-black">List Kapal</h5>
                        ...
                        <table id="table-perusahaan" class="display table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('pelayanan.ppkp.form', $item->id) }}"><button class="btn btn-primary">Pilih</button></a>
                                    </td>
                                </tr>
                                @endforeach
