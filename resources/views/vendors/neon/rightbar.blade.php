                    ...
                    <ul class="list-inline mb-0">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="xp-message">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="media xp-msg">
                                            <img class="mr-3 align-self-center rounded-circle" src="{{ url('vendors/neon/images/topbar/user-message-1.jpg') }}" alt="Generic placeholder image">
                                            <div class="media-body">
                                                <a href="#">  
                                        ...
                                        <li class="media xp-msg">
                                            <img class="mr-3 align-self-center rounded-circle" src="{{ url('vendors/neon/images/topbar/user-message-2.jpg') }}" alt="Generic placeholder image">
                                            <div class="media-body">
                                                <a href="#">
                                        ...
                                        <li class="media xp-msg">
                                            <img class="mr-3 align-self-center rounded-circle" src="{{ url('vendors/neon/images/topbar/user-message-3.jpg') }}" alt="Generic placeholder image">
                                            <div class="media-body">
                                                <a href="#">
                        ...
                        <li class="list-inline-item mr-0">
                            <div class="dropdown xp-userprofile">
                                <a class="dropdown-toggle" href="#" role="button" id="xp-userprofile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ url('vendors/neon/images/topbar/user.jpg') }}" alt="user-profile" class="rounded-circle img-fluid"><span class="xp-user-live"></span></a>
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="xp-userprofile">
                                    <a class="dropdown-item py-3 text-white text-center font-16" href="#">Selamat Datang, {{ auth()->user()->nama_lengkap }}</a>
                                    ...
                                    <a class="dropdown-item" href="{{ route('auth.logout') }}"><i class="icon-power text-danger mr-2"></i> Logout</a>
                                </div>
                            </div>                                   
                        </li>
                    </ul>
